...
<form:form action="${url}" modelAttribute="user">
	    ...
	    <label> <spring:message code="user.userAccount.username"/> </label><br />
		<input class="form-control" value="${user.userAccount.username}" type="text" name="userAccount.username"/>
		<form:errors cssClass="error" path="userAccount.username" /> <br />
		
		<label> <spring:message code="actor.userAccount.password"/> </label><br />
		<input class="form-control" value="${user.userAccount.password}" type="password" name="userAccount.password"/>
